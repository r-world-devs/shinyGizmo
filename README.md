...
[![version](https://img.shields.io/static/v1.svg?label=github.com&message=v.0.3.1&color=ff69b4)](https://img.shields.io/static/v1.svg?label=github.com&message=v.0.1&color=ff69b4)
...
## <span style="color:blue"> shinyGizmo 0.3.1 is now available!</span>
