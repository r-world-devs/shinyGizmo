...
[![version](https://img.shields.io/static/v1.svg?label=github.com&message=v.0.2.2&color=ff69b4)](https://img.shields.io/static/v1.svg?label=github.com&message=v.0.1&color=ff69b4)
...
## <span style="color:blue"> shinyGizmo 0.2.2 is now available!</span>
